...
public class StudentBean {
	...
	private String graduationSpeciality;
	...
	public String getGraduationSpeciality() {
		return graduationSpeciality;
	}
	...
	public String getPreferredStudentStream() {
		return preferredStudentStream;
	}
	public void setPreferredStudentStream(String preferredStudentStream) {
		this.preferredStudentStream = preferredStudentStream;
	}
	public String getAssignedStream() {
		return assignedStream;
	}
	public void setAssignedStream(String assignedStream) {
