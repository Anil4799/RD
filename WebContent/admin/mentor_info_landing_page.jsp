...
<div class="container">
				...
				<tr>
					...
					<td>
						<select class="form-control" name="technologystream">
						 	<option value="" selected="selected" hidden="hidden">Technology Stream</option>
	...
	<c:if test="${result eq true}">
		<form action="adminMentorSearchServlet" method="post">
			<table class="table">
				<tr>
					<td><input type="text" class="form-control" placeholder="Mentor Name" name ="mentorname" value="${mentorname}"></td>
					<td>
						<select class="form-control" name="technologystream">
							<c:choose>
								<c:when test="${fn:length(technologystream) eq 0}">
									<option value="" selected="selected" hidden="hidden">Technology Stream</option>
								</c:when>
								<c:when test="${fn:length(technologystream) gt 0}">
									<option value="${technologystream}" selected="selected" hidden="hidden">${technologystream}</option>
